    ...
    <tr className="border-b border-border-light">
      ...
      <td className="px-4 py-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            onClick={() => navigate(`/admin/theaters/${theater._id}/screens`)}
            className="flex items-center gap-1.5 rounded-lg bg-orange-50 px-3 py-1.5 text-sm font-semibold text-primary transition hover:bg-primary hover:text-white"
          >
            <Monitor size={14} />
            Manage Screens
          </button>
